...
public class SaveSeeds {
    ...
    public SaveSeeds(String UniqueID,String name,String phone,String email,Boolean Rice,Boolean Onion,Boolean Tomato,Boolean Bendi,Boolean Brinjal,Boolean Pumpkin,
